...
const EARLY_ORDER_SWITCH_AT=Date.parse('2026-10-31T20:01:00+09:00');
function isEarlyOrderPeriod(now=Date.now()){return now<EARLY_ORDER_SWITCH_AT;}
...
const FACILITIES={saga:{name:'メモリード佐賀',categories:[
 {key:'osechi',pickup:PICKUP_OSECHI,dates:DATES_OSECHI,items:[{no:1,name:'プレミアムおせち',e:33000,eTax:2444,g:37000,s:35000,gTax:2740,sTax:2592,limit:200},{no:2,name:'特選おせち',price:22000,tax:1629,limit:150}]},
